...
pygame.mixer.music.load("lab7\sound.mp3")
...
mickey_surf = pygame.image.load(r"lab7\pic.jpg")
left_hand_surf = pygame.image.load(r"lab7\left_hand mickey.png").convert_alpha()
right_hand_surf = pygame.image.load(r"lab7\right_hand mickey.png").convert_alpha()
